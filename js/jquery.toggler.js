(function($, window, document, undefined) {
  ...
  function CheckToggler(element, options) {
    ...
    this._template =
      '<div class="ui-stoggle on"><div class="ui-stoggle--inner"><span class="ui-stoggle--label-on"><i class="ui-stoggle--label-text">On</i></span><span class="ui-stoggle--label-off"><i class="ui-stoggle--label-text">Off</i></span></div><span class="ui-stoggle--slider"><i></i></span></div>';
  ...
  CheckToggler.prototype = {
    init: function() {
      ...
      this.$uiToggleLabelOnText = $(
        ".ui-stoggle--label-on .ui-stoggle--label-text",
        this.$uiToggle
      ).text(this.settings.labelOn);
      this.$uiToggleLabelOffText = $(
        ".ui-stoggle--label-off .ui-stoggle--label-text",
        this.$uiToggle
      ).text(this.settings.labelOff);
